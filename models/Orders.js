...
class Orders
{
  static getFilteredTable(startDate, endDate,location, numberOfRooms, fromPrice, unitTypes, orderNumber, callback){
     console.log(startDate, endDate,location, numberOfRooms, fromPrice, unitTypes, orderNumber);
